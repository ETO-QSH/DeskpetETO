...
int main() {
	...
	Atlas *atlas = new Atlas("data/official/spineboy-pma.atlas", &textureLoader);
	SkeletonBinary binary(atlas);
	SkeletonData *skeletonData = binary.readSkeletonDataFile("data/official/spineboy-pro.skel");
